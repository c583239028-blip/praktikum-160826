...
- [ ] ⭐ הוספת/שינית **תלות native** ב-`package.json`? כל הצוות צריכה לבנות מחדש את ה-dev client (APK ישן קורס ב-runtime), ו**אסור** `prebuild --clean` (דורס netfree). ראי [CONTRIBUTING.md §4](CONTRIBUTING.md).
...
## 9. איכות ומוכנות למיזוג לפני PR
...
## 10. שאלות "ראייה כוללת" לפני סימון סיום

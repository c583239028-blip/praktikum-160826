...
// ההשערה היא socket event game:room_update (SOCKET_EVENTS.GAME.ROOM_UPDATE),
// אבל payload מדויק לא אושר עדיין - לא לבנות על ההשערה הזו בלי אישור.
...
export const { updateStreamStats, resetStreamStats } =
  streamStatsSlice.actions;

...
| 13 | Viewer – In-stream Animation & End-of-game Popup | `7816:57287` | ✅ |
...
- ⚠️ **Grid = remote only, and the remote frames here are MISSING** — the `2/3/4 שחקנים` exported into
  ...
  See C2 + the Multi-Camera Grid epic in [DEEP-DIVE.md](DEEP-DIVE.md). **Close-up has no grid** (single video
  + avatars row).
...
- **In-stream animation:** win `אנימציה תוך שידורית - זכייה` `7794:56955`; loss `…הפסד` `7794:57023`
- **End-of-game popup:** win `פופ-אפ סיום משחק - זכייה` `7794:57091`; loss/neutral `…הפסד / ניטרלי`
  `7794:57127`; ⚠️ **no-bets** `פופ-אפ סיום משחק - ללא הימורים` `7829:46377` (extra state, add to SPEC §6.3)
